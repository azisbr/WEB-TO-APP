            ...
            >
              ...
              <div className="bg-surface rounded-3xl p-6 md:p-8 shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-border mt-4">
                ...
                <div className="mt-10 pt-6 border-t border-border/50">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                     ...
                     <div className="flex flex-col gap-1 items-center bg-white p-3 rounded-2xl shadow-sm border border-border">
                        ...
                        <div className="flex items-center gap-1.5"><CheckCircle2 className="w-3.5 h-3.5 text-[#148348]"/> <span className="font-bold text-xs text-[#148348]">Unlimited</span></div>
                     </div>
                  </div>
                </div>
                ...
                <div className="mt-8 text-center flex flex-col items-center">
                   ...
                   <div className="text-sm font-black text-primary tracking-tight">ZIICODEX</div>
                </div>
              </div>
